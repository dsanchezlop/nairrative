...
const FEATURES = [
  {
    ...
    description:
      "Crea personajes, historias, mundos y encuentros al instante con Groq, Llama y Pollinations FLUX.",
  },
  {
    icon: BookOpen,
    title: "Historial de textos",
    description:
      "Todos tus textos guardados en un solo lugar, filtrados por categoría.",
  },
  {
    icon: Users,
    title: "Cuentas personales",
    description:
      "Tus historias son privadas. Solo tú puedes verlas y editarlas.",
  },
];
    ...
    <div className="min-h-screen bg-[#0d0d1a] text-white flex flex-col">
      ...
      <header className="border-b border-purple-900/30 px-6 h-16 flex items-center justify-between max-w-5xl mx-auto w-full">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold text-purple-200 tracking-wide">
            NAIrrative
          </span>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 py-20 max-w-3xl mx-auto w-full">
        ...
        <p className="text-lg text-gray-400 mb-10 max-w-xl">
          Genera personajes épicos, historias inmersivas, mundos detallados y
          encuentros emocionantes para tus partidas de rol en segundos.
        </p>
        ...
        <div className="flex gap-4 flex-wrap justify-center">
          <Link
            ...
            className={cn(
              ...
              "bg-purple-700 hover:bg-purple-600 text-white font-semibold px-8",
            )}
          >
            Empezar gratis
          </Link>
          <Link
            ...
            className={cn(
              ...
              "border-purple-800 text-purple-300 hover:bg-purple-900/30 hover:text-white px-8",
            )}
          >
            Ya tengo cuenta
          </Link>
      ...
      <section className="max-w-5xl mx-auto w-full px-6 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {FEATURES.map((f) => (
            <div
              key={f.title}
              className="bg-[#12122a] border border-purple-900/30 rounded-xl p-6 space-y-3"
            >
